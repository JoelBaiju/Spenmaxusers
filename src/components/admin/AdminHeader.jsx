            ...
            <div className=' mx-auto px-4 py-2 md:flex md:justify-between md:items-center'>
                ...
                <div className={`md:flex ${isMenuOpen ? 'block' : 'hidden'}`}>
                    <div className='flex flex-col md:flex-row md:space-x-4 items-center mt-4 md:mt-0'>
                        <AdminHeadNavItem icon='/dashboards.png' text='DashBoard' to="/admin-home" />
                        <AdminHeadNavItem icon='/gift.png' text='Packages' to="/admin-home/add-package" />
                        <AdminHeadNavItem icon='/list.png' text='Categories' to="/admin-home/add-Catogries" />
                        <AdminHeadNavItem icon='/customer.png' text='Customers' to="/admin-home/add-Customers" />
                        <AdminHeadNavItem icon='/team.png' text='Partner' to="/admin-home/add-Parnter" />
                        <AdminHeadNavItem icon='/bar-chart.png' text='Ads' to="/admin-home/add-Ads" />
                        <AdminHeadNavItem icon='/bell (2).png' text='Notifications' to="/admin-home/Notification"  notificationCount={notificationCount} onClickFuntion={onClickFuntion} />
                    </div>
