                ...
                <div className='md:flex gap-6 mt-2 '>
                    ...
                    <div className='md:w-6/12 '>
                        ...
                        <div className='flex  mt-4'>
                            <button type='button' className='py-1  px-2 mx-4 bg-[#507b7d] rounded-lg text-white w-3/6 ' onClick={addMore}>Add more</button>
                            <button type='submit' className='py-1 px-2 mx-4 bg-[#507b7d] rounded-lg text-white w-3/6 '>Next</button>
